 ...
 *
 */
class EndGroup implements WireTypeInterface
{

    public static function read(ReaderInterface $reader)
    {
        throw new \PhpBuf\NotImplemented\Exception("reader for PhpBuf\WireType\EndGroup not implemented");
    }

    public static function write(WriterInterface $writer, $data)
    {
        throw new \PhpBuf\NotImplemented\Exception("writer for PhpBuf\WireType\EndGroup not implemented");
    }
